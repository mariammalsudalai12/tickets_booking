...
<div className="facilities-section w-100 my-5">
  <h3 className="facilities-heading text-center mb-4">Facilities Available</h3>
  <div className="facilities-wrapper d-flex justify-content-center flex-wrap">
    <div className="facility-item col-10 col-md-3 mb-4 text-center">
